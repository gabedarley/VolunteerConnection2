...
events = [
  ...
  {:name => 'Dog Walking',
    :description => 'Morning dog walking, kennel cleaning, feeding and cat care (feeding/cleaning kennels and condos/new litter) are all part of the job!',
    :date => '2021-12-04',
    :start_time => DateTime.new(2021,12,4,9,00),
    :end_time => DateTime.new(2021,12,4,13,00),
    :link => 'https://animalrescueneworleans.org/volunteer/',
    :organization_id => 20},
  {:name => 'Dog Walking',
    :description => 'Morning dog walking, kennel cleaning, feeding and cat care (feeding/cleaning kennels and condos/new litter) are all part of the job!',
    :date => '2021-12-07',
    :start_time => DateTime.new(2021,12,7,9,00),
    :end_time => DateTime.new(2021,12,7,13,00),
    :link => 'https://animalrescueneworleans.org/volunteer/',
    :organization_id => 20},
  {:name => 'Dog Walking',
    :description => 'Morning dog walking, kennel cleaning, feeding and cat care (feeding/cleaning kennels and condos/new litter) are all part of the job!',
    :date => '2021-12-08',
    :start_time => DateTime.new(2021,12,8,9,00),
    :end_time => DateTime.new(2021,12,8,13,00),
    :link => 'https://animalrescueneworleans.org/volunteer/',
    :organization_id => 20},
  {:name => 'Shelter Chores',
