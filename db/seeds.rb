...
organizations = [
  ...
  {:name => 'Animal Rescue New Orleans',
   :address => '1219 Coliseum St., New Orleans, LA 70130', 
   :web_address => 'https://animalrescueneworleans.org', 
   :contact_phone => '504-571-1900', 
   :contact_email  => 'volunteer@animalrescueneworleans.org',
   :category => 'Rescue',
   :image => 'arno.jpg'}  
]
...
events = [
  ...
  {:name => 'Barrel Painting',
    ...
    :organization_id => 11},
  {:name => 'Event Support',
    :description => 'Volunteers will assist staff members in scanning tickets, taking pictures of guests at photo opportunities, and assisting with food and beverage operations.',
    :date => '2021-12-16',
    :start_time => DateTime.new(2021,12,16,5,30),
    :end_time => DateTime.new(2021,12,16,9,00),
    :link => 'https://friendsofcitypark.volunteerhub.com/?format=0&filter={}',
    :organization_id => 19},
  {:name => 'Event Support',
    :description => 'Volunteers will assist staff members in scanning tickets, taking pictures of guests at photo opportunities, and assisting with food and beverage operations.',
    :date => '2021-12-17',
    :start_time => DateTime.new(2021,12,17,4,30),
    :end_time => DateTime.new(2021,12,17,9,00),
    :link => 'https://friendsofcitypark.volunteerhub.com/?format=0&filter={}',
    :organization_id => 19},
  {:name => 'Dog Walking',
    :description => 'Morning dog walking, kennel cleaning, feeding and cat care (feeding/cleaning kennels and condos/new litter) are all part of the job!',
    :date => '2021-12-21',
    :start_time => DateTime.new(2021,12,21,9,00),
    :end_time => DateTime.new(2021,12,21,13,00),
    :link => 'https://animalrescueneworleans.org/volunteer/',
    :organization_id => 20},
  {:name => 'Dog Walking',
    :description => 'Morning dog walking, kennel cleaning, feeding and cat care (feeding/cleaning kennels and condos/new litter) are all part of the job!',
    :date => '2021-12-22',
    :start_time => DateTime.new(2021,12,22,9,00),
    :end_time => DateTime.new(2021,12,22,13,00),
    :link => 'https://animalrescueneworleans.org/volunteer/',
    :organization_id => 20},
  {:name => 'Dog Walking',
    :description => 'Morning dog walking, kennel cleaning, feeding and cat care (feeding/cleaning kennels and condos/new litter) are all part of the job!',
    :date => '2021-12-23',
    :start_time => DateTime.new(2021,12,23,9,00),
    :end_time => DateTime.new(2021,12,23,13,00),
    :link => 'https://animalrescueneworleans.org/volunteer/',
    :organization_id => 20},
  {:name => 'Dog Walking',
    :description => 'Morning dog walking, kennel cleaning, feeding and cat care (feeding/cleaning kennels and condos/new litter) are all part of the job!',
    :date => '2021-12-24',
    :start_time => DateTime.new(2021,12,24,9,00),
    :end_time => DateTime.new(2021,12,24,13,00),
    :link => 'https://animalrescueneworleans.org/volunteer/',
    :organization_id => 20},
  {:name => 'Dog Walking',
    :description => 'Morning dog walking, kennel cleaning, feeding and cat care (feeding/cleaning kennels and condos/new litter) are all part of the job!',
    :date => '2021-12-25',
    :start_time => DateTime.new(2021,12,25,9,00),
    :end_time => DateTime.new(2021,12,25,13,00),
    :link => 'https://animalrescueneworleans.org/volunteer/',
    :organization_id => 20},
  {:name => 'Shelter Chores',
    :description => 'Afternoon dog walks, kennels cleaned if needed, supervised playtime designated play area; cat socialization (petting and brushing), laundry, dishes.',
    :date => '2021-12-21',
    :start_time => DateTime.new(2021,12,21,14,00),
    :end_time => DateTime.new(2021,12,21,17,00),
    :link => 'https://animalrescueneworleans.org/volunteer/',
    :organization_id => 20},
  {:name => 'Shelter Chores',
    :description => 'Afternoon dog walks, kennels cleaned if needed, supervised playtime designated play area; cat socialization (petting and brushing), laundry, dishes.',
    :date => '2021-12-22',
    :start_time => DateTime.new(2021,12,22,14,00),
    :end_time => DateTime.new(2021,12,22,17,00),
    :link => 'https://animalrescueneworleans.org/volunteer/',
    :organization_id => 20}
]
