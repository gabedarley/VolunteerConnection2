...
events = [
  ...
  {:name => 'Volunteers sign-up for Food Sorting and Packing',
  ...
  {:name => 'Virtual Hurricane Recovery: Valuing Donated Items',
  ...
  {:name => 'Ida Response - Serve our Seniors Food Packaging/Loading',
  ...
  {:name => 'Volunteer runners for deliveries to households!',
  ...
  {:name => 'Volunteers needed for the 2022 Essence Music Festival',
  ...
  {:name => 'Stained Glass 5K Run 4 Cause',
  ...
  {:name => '2022 Disaster Relief Training',
